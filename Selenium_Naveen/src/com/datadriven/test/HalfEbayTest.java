...
public class HalfEbayTest {
	...
	{
		ArrayList<Object[]> testData =TestUtility.getTestData();
		return testData.iterator();
	}
	
	@Test(dataProvider="getTestdata")
	public void halfEbayRegPageTest(String firstName,String lastName, String address1, String address2, String city, String state,String pinCode, String emailAddress  )
	{
		//Enter Test Data::
